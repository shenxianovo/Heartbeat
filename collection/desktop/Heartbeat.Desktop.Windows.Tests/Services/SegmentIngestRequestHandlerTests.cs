...
public class SegmentIngestRequestHandlerTests : IDisposable
{
    ...
    {
        _config.Update(c => c.Collectors["browser"] = new Heartbeat.Desktop.Windows.Models.CollectorEntry { Enabled = false });
    ...
    public async Task MixedBatch_OneDisabled_403()
    {
        ...
        _config.Update(c => c.Collectors["vscode"] = new Heartbeat.Desktop.Windows.Models.CollectorEntry { Enabled = false });
