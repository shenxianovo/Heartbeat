namespace Heartbeat.Desktop.Windows.Models
{
    public class AgentConfig
    {
        // ApiBaseUrl / AuthServiceBaseUrl 已退役：服务端点为代码常量（Collection.Hub.Http.Endpoints），
        ...
        // （Collection.Hub Runtime 的 keepalive 常量），旧 config.json 中的字段被反序列化静默忽略。
        ...
        /// 被占时向上顺延试绑（范围见 Collection.Hub ExternalHostProtocolWorker.PortRange），采集器按同一范围探测发现。
