...
import { groupSubjects, presentFact, rangeOf, type ExperienceSegment, type TimeRange } from './factViews'
...
const groups = computed(() => groupSubjects(props.facts, props.bounds))
