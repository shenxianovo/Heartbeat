...
public sealed class MacAccessibilityNative : IMacAccessibilityNative, IDisposable
{
    ...
    public bool IsObservingApplication(int processIdentifier)
    {
        lock (_gate)
            return _session is { } session && !session.Thread.IsStopping
                && !session.Thread.Completion.IsCompleted
                && session.ObservedProcessIdentifier == processIdentifier;
    }
    ...
    private sealed class Session
    {
        ...
        public int ObservedProcessIdentifier => Volatile.Read(ref _observedProcessIdentifier);
        ...
        private void RunObserverLoop(CancellationToken cancellationToken)
        {
            ...
            {
                Console.Error.WriteLine($"macOS Accessibility observer stopped: {exception.Message}");
                throw;
            }
            finally
            {
        ...
        private bool AttachObserver(int processIdentifier)
        {
            ...
            Volatile.Write(ref _observedProcessIdentifier, processIdentifier);
            return true;
        }
        ...
        private void DetachObserver()
        {
            ...
            Volatile.Write(ref _observedProcessIdentifier, 0);
        }
        ...
        internal static string? ReadFocusedWindowTitle(nint application, out nint focusedWindow)
        {
            ...
            var error = Native.AXUIElementCopyAttributeValue(
                ...
                out focusedWindow);
            if (!MacAccessibilityReadResult.HasValue(error, focusedWindow))
                return null;
            ...
            try
            {
                ...
                return MacAccessibilityReadResult.HasValue(error, titleValue)
