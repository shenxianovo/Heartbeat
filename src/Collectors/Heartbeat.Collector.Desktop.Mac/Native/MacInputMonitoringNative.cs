...
public sealed class MacInputMonitoringNative : IMacInputMonitoringNative, IDisposable
{
    ...
    private const uint ScrollWheelEventDeltaAxis2 = 12;
    private const uint ScrollWheelEventIsContinuous = 88;
    private const uint ScrollWheelEventPointDeltaAxis1 = 96;
    private const uint ScrollWheelEventPointDeltaAxis2 = 97;
    private static readonly uint[] ObservedEventTypes = [1, 3, 10, 11, 12, 22, 25];
    ...
    private sealed class Session
    {
        ...
        private void RunEventLoop(CancellationToken cancellationToken)
        {
            ...
            {
                Console.Error.WriteLine($"macOS Input Monitoring event tap stopped: {exception.Message}");
                throw;
            }
            finally
            {
            ...
            nint userInfo)
        {
            ...
            try
            {
                ...
                if (handle.Target is not Session session)
                ...
                var lineScrollX = Native.CGEventGetIntegerValueField(
                    eventReference,
                ...
                var pointScrollX = Native.CGEventGetIntegerValueField(
                    eventReference,
                ...
                if (MacInputNativeEventTranslator.TryTranslate(
                    ...
                    pointScroll,
                    out var observation,
                    Native.CGEventGetFlags(eventReference)))
                {
            ...
            {
                Console.Error.WriteLine($"macOS Input Monitoring callback failed: {exception.Message}");
                instance?.Thread.Fail(exception);
            }
            return eventReference;
        }
    ...
    private static class Native
    {
        ...
        [DllImport(ApplicationServices)]
        public static extern ulong CGEventGetFlags(nint eventReference);
