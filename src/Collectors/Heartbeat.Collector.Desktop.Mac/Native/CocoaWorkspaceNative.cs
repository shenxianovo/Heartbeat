...
public sealed class CocoaWorkspaceNative : IMacWorkspaceNative, IDisposable
{
    ...
    private static class Native
    {
        ...
        [DllImport(ObjCLibrary, CharSet = CharSet.Ansi)]
        public static extern nint objc_allocateClassPair(nint superclass, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, nuint extraBytes);

        [DllImport(ObjCLibrary, CharSet = CharSet.Ansi)]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool class_addMethod(nint cls, nint name, nint implementation, [MarshalAs(UnmanagedType.LPUTF8Str)] string types);
        ...
        public static extern nint objc_msgSend_string(nint receiver, nint selector, [MarshalAs(UnmanagedType.LPUTF8Str)] string value);
    }
}
