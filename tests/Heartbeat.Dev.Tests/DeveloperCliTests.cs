...
public sealed class DeveloperCliTests
{
    ...
    [InlineData("scenario", "runtime-replay", "--help")]
    ...
    [InlineData("scenario", "desktop-replay")]
    [InlineData("scenario", "runtime-replay", "--interactive-login")]
    [InlineData("scenario", "runtime-replay", "--foreground")]
