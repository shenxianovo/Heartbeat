...
| 回放体验 | Web `/`，OIDC `/auth/callback` | `scenario replay-fixture` | [前端 README](../../../../../src/Frontend/Heartbeat.Web/README.md)、[记录接口](../../../../../docs/recording-api.md)、[体验验收](../../../../../docs/validation/experience-visualization.md) | 认证和 API 均为 mock，不是 Collector 到 Web 的真实端到端验证 |
