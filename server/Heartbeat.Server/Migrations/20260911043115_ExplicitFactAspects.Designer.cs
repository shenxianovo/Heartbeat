...
namespace Heartbeat.Server.Migrations
{
    ...
    [Migration("20260911043115_ExplicitFactAspects")]
    partial class ExplicitFactAspects
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Heartbeat.Server.Entities.FactRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerId", "TargetKind", "TargetId");

                    b.HasIndex("OwnerId", "Kind", "StreamId", "FactId")
                        .IsUnique();
                    ...
                    b.HasDiscriminator<string>("Kind").HasValue("FactRecord");
            ...
            modelBuilder.Entity("Heartbeat.Server.Entities.ServiceAccount", b =>
                {
                    ...
                    b.HasIndex("OwnerId", "ServiceKey", "LegacySubjectId")
                        .IsUnique();

                    b.HasIndex("OwnerId", "ServiceKey", "ServiceAccountId")
                        .IsUnique();

                    b.ToTable("ServiceAccounts", null, t =>
                        {
                            t.HasCheckConstraint("CK_ServiceAccounts_Identity", "(\"ServiceAccountId\" IS NOT NULL AND \"LegacySubjectId\" IS NULL) OR (\"ServiceAccountId\" IS NULL AND \"LegacySubjectId\" IS NOT NULL)");
                        });
                });

            modelBuilder.Entity("Heartbeat.Server.Entities.ServiceProduct", b =>
                {
                    b.Property<string>("ServiceKey")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("Heartbeat.Server.Entities.Event", b =>
                {
                    b.HasBaseType("Heartbeat.Server.Entities.FactRecord");
            ...
            modelBuilder.Entity("Heartbeat.Server.Entities.Segment", b =>
                {
                    b.HasBaseType("Heartbeat.Server.Entities.FactRecord");
                    ...
                    b.HasIndex("OwnerId", "Aspect", "StartTime")
                        .HasFilter("\"Kind\" = 'segment'");

                    b.HasIndex("OwnerId", "Source", "StartTime");
