...
namespace Heartbeat.Agent.Mac.Tests.Hosting;
...
public sealed class MacAgentHostExtensionsTests : IDisposable
{
    ...
    public void FirstLaunch_DisablesInputRecording_AndUsesVersionedPlatformCaches()
    {
        ...
        _ = provider.GetRequiredService<Heartbeat.Hub.Core.Storage.ICache<Heartbeat.Core.DTOs.Segments.ActivitySegmentItem>>();
        _ = provider.GetRequiredService<Heartbeat.Hub.Core.Storage.ICache<Heartbeat.Core.DTOs.Input.InputEventItem>>();
