...
- `Heartbeat.Desktop.Update` 统一承载 Windows/macOS 的 Velopack Update 生命周期（检查、下载、重试、ReadyToApply 门控与调度应用）；platform head 只选择 Release channel，并在 updater 成功启动后停止 Agent、退出当前进程
